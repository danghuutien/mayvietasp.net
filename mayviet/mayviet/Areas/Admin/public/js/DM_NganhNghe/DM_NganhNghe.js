    ...
    methods: {
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/Admin/DM_NganhNghe/Create", self.dataForm.data).then(function (response) {
                ...
                axios.post("/Admin/DM_NganhNghe/Edit",
                    {
                        id: self.rowId,
                        TenNganhNghe: self.dataForm.data.TenNganhNghe,
                    }
                )
        ...
        doAlertEdit(data) {
            ...
            self.dataForm.TenNganhNghe = data.TenNganhNghe;
        ...
        doAlertDelete(data) {
            ...
            this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                ...
                axios.post("/Admin/DM_NganhNghe/Delete", data)
                    .then(function (response) {
                        self.loadData();
