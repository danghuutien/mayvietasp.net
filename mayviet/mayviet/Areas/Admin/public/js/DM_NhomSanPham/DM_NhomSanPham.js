    ...
    methods: {
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/Admin/DM_NhomSanPham/Create", self.dataForm.data).then(function (response) {
                ...
                axios.post("/Admin/DM_NhomSanPham/Edit",
                    {
                        id: self.rowId,
                        TenNhomSanPham: self.dataForm.data.TenNhomSanPham,
                    }
                )
        ...
        doAlertEdit(data) {
            ...
            self.dataForm.TenNhomSanPham = data.TenNhomSanPham;
        ...
        doAlertDelete(data) {
            ...
            this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                ...
                axios.post("/Admin/DM_NhomSanPham/Delete", data)
                    .then(function (response) {
                        self.loadData();
